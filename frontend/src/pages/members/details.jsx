...
export default function MemberDetails() {
  ...
  return <ResourceState {...r}>{m && <div className="container py-4" style={{
      maxWidth: 800
    }}><h1 className="mb-3"><T>{"Member Details"}</T></h1><nav className="detail-toolbar mb-4" aria-label="Member actions"><Back to="/members">Back to Members</Back></nav><div className="card detail-hero text-center p-4 mb-4"><i className="bi bi-person-circle display-4 mb-2" /><span className="display-serif" style={{
          fontSize: 36
